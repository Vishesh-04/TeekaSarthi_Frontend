  ...
  const fetchBeneficiaries = async () => {
    try {
      ...
      const response = await axiosClient.get(
        `api/beneficiaries/email/${userId}`
      );
        ...
        <div className="max-w-7xl mx-auto text-center px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="bg-[#C8D64A] rounded-[4rem] shadow-xl flex flex-col items-center text-center py-8 px-4">
              ...
              <a
                href="https://drive.google.com/file/d/1F09YrxtICD5kklUr5AZOe20dztcrQfhD/view?usp=sharing"
            ...
            <div className="bg-[#F7B538] rounded-[4rem] shadow-xl flex flex-col items-center text-center py-8 px-4">
              ...
              <a
                href="https://drive.google.com/file/d/1ImhcgBLGCuLLcSH7T1ukbwEqcj2TODMm/view?usp=sharing"
                className="text-indigo-900 font-semibold mt-4 flex items-center justify-center gap-2 hover:text-indigo-700 transition-all"
              >
                Download
                <svg
            ...
            <div className="bg-[#EB5E7A] rounded-[4rem] shadow-xl flex flex-col items-center text-center py-8 px-4">
              ...
              <a
                href="https://drive.google.com/file/d/1xJcMu8aWZC_40tEcQzri61ym7Rxfb3cv/view?usp=sharing"
                className="text-indigo-900 font-semibold mt-4 flex items-center justify-center gap-2 hover:text-indigo-700 transition-all"
              >
                Download
                <svg
      ...
      <section className="flex flex-col md:flex-row items-center justify-between bg-white mt-12 px-10 py-16 rounded-3xl shadow-lg">
        ...
        <div className="md:w-1/2 space-y-5">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            Teeka Sarthi is a unified digital vaccination management platform
            designed to simplify how families, health workers, and supervisors
            manage immunization data. It ensures timely vaccination, transparent
            reporting, and seamless coordination across all health centers.
          </p>
          ‌
